    ...
    <section class="mk-wrapper">
        ...
        <div class="mk-filter">
            ...
            <div class="filter-row">
                ...
                <select><option>2025/2026 Semester Ganjil</option></select>
            </div>
            <button class="mk-apply-btn">Apply</button>
        </div>

        <div class="mk-info-box">Tempat Info</div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-group">
                                    <button type="button" class="btn-edit" onclick="openEditMkModal('{{ $mk[0] }}')">Edit</button>
                                    <a href="{{ route('mata-kuliah.manage-plo.ui') }}" class="btn-manage">Manage PLO</a>
                                    <button type="button" class="btn-detail" onclick="openDetailAtModal('{{ $mk[0] }}')">Detail</button>
                                </div>
                            </td>
                        </tr>
                    @endforeach
            ...
            <div class="detail-at-modal">
                ...
                <div class="detail-meta-row">
                    <div class="detail-meta-item">
                        <label>Kode Mata Kuliah</label>
                        <div class="detail-meta-box"><span id="detailMkCode"></span></div>
                    </div>
                    <div class="detail-meta-item">
                        <label>Tahun Akademik</label>
                        <div class="detail-meta-box"><span id="detailMkTahun"></span></div>
                    </div>
                </div>
                <div class="detail-table-wrap">
                    <table class="detail-at-table">
                        ...
                        <tbody>
                            <tr><td>1</td><td>UAS CLO 1</td><td>10</td><td>Ujian Akhir Semester</td></tr>
                            <tr><td>2</td><td>TUGAS 2 CLO 6</td><td>5</td><td>Tugas</td></tr>
                            <tr><td>3</td><td>QUIZ 2 CLO 6</td><td>10</td><td>Tugas Akhir</td></tr>
                        </tbody>
                    </table>
                </div>
...
@section('scripts')
    <script>
        ...
        function openEditMkModal(kode) {
            const mk = matkulData.find(i => i[0] === kode);
            if (!mk) return;
            document.getElementById('editMkCode').textContent = mk[0];
            document.getElementById('editMkStatus').checked = mk[5] === 'Active';
        ...
        function openDetailAtModal(kode) {
            const mk = matkulData.find(i => i[0] === kode);
            if (!mk) return;
            document.getElementById('detailMkCode').textContent  = mk[0];
            document.getElementById('detailMkTahun').textContent = mk[4] + ' - Genap';
            document.getElementById('detailAtModal').classList.add('show');
        }
        function closeDetailAtModal() { document.getElementById('detailAtModal').classList.remove('show'); }
    </script>
@endsection
