            ...
            <div class="detail-table-wrap">
                <table class="detail-table">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center">Detail nilai untuk PLO ini belum tersedia.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
