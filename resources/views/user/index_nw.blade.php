...
<section class="mk-wrapper">
    ...
    <div style="margin-bottom:12px;">
        <button type="button" class="mk-apply-btn" onclick="openAddUserModal()">+ Tambah User</button>
    </div>
    @endif
        ...
        <table class="mk-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span style="padding:2px 10px;border-radius:10px;font-size:0.82em;font-weight:600;
                ...
                @empty
                <tr><td colspan="8" style="text-align:center;">Belum ada user.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
            ...
            <form method="POST" action="{{ route('users.store') }}">
                ...
                <div class="edit-modal-body">
                    ...
                    <div class="edit-field-group" id="addKodeDosenGroup">
                        ...
                        <input type="text" name="kode_dosen" maxlength="3" placeholder="TRL" style="text-transform:uppercase;">
                    </div>
                    <div class="edit-field-group">
                        <label>NIP</label>
            ...
            <form id="editUserForm" method="POST" action="">
                ...
                <div class="edit-modal-body">
                    ...
                    <div class="edit-field-group" id="editKodeDosenGroup">
                        <label>Kode Dosen (3 huruf)</label>
                        <input type="text" id="editKodeDosen" name="kode_dosen" maxlength="3" style="text-transform:uppercase;">
                    </div>
                    <div class="edit-field-group">
                        <label>NIP</label>
